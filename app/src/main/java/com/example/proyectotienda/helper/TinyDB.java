...
public class TinyDB {
    ...
    public ArrayList<ClothDomain> getListObject(String key){
        Gson gson = new Gson();

        ArrayList<String> objStrings = getListString(key);
        ArrayList<ClothDomain> playerList =  new ArrayList<ClothDomain>();

        for(String jObjString : objStrings){
            ClothDomain player  = gson.fromJson(jObjString,  ClothDomain.class);
    ...
    public void putListObject(String key, ArrayList<ClothDomain> playerList){
        checkForNullKey(key);
        Gson gson = new Gson();
        ArrayList<String> objStrings = new ArrayList<String>();
        for(ClothDomain player: playerList){
